...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        auth
                ...
                .and()
                .withUser("backoffice1").password("{noop}appel").roles("BACKOFFICE", "EMPLOYEE")
                .and()
                .withUser("administrator1").password("{noop}bosbes").roles("ADMINISTRATOR", "EMPLOYEE")
                .and()
                .withUser("super").password("{noop}kiwi").roles("MECHANIC", "BACKOFFICE", "ADMINISTRATOR", "EMPLOYEE")
        ;
    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/customers/**").hasAnyRole("ADMINISTRATOR")
                ...
                .antMatchers("/stock/**").hasAnyRole( "BACKOFFICE")
